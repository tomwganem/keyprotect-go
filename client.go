...
// APIClient manages communication with the IBM Key Protect API API v2.0.0
...
type APIClient struct {
	...
	LockersBetaApi *LockersBetaApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.LockersBetaApi = (*LockersBetaApiService)(&c.common)
